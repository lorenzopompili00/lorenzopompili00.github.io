...
Invited talks and seminars are marked with \*.

- **09/2026**: \* gweccentricity Workshop, Corfu.
  - Panel member: *Detecting eccentricity: current evidence and future prospects*

- **03/2026**: LIGO-Virgo-KAGRA Collaboration Meeting, Pisa.
...
- **12/2025**: \* GWSky Workshop, Potsdam.
  - Panel member: *Machine learning methods for waveform calibration*

- **12/2025**: GWPAW, Atlanta.
  - *Black Hole Spectroscopy and Tests of General Relativity with GW250114*

- **11/2025**: \* Astrophysics Group Seminar, Birmingham.
  - *Testing general relativity with black hole ringdowns*

- **10/2025**: \* Self-Force Group Seminar, Southampton.
  - *Ever more accurate effective-one-body waveforms for gravitational-wave astrophysics*

- **03/2025**: LIGO-Virgo-KAGRA Collaboration Meeting, Melbourne.
  - *Incorporating antisymmetric multipoles for spin-precessing binary signals into the SEOBNR framework*

- **03/2025**: \* AstroBicocca Seminar, Milan.
  - *Systematic biases in gravitational-wave models: incorporating waveform uncertainty in the parameter estimation of binary-black-hole signals*

- **03/2025**: \* TianQin Student Seminar, virtual.
  - *Systematic biases in gravitational-wave models: incorporating waveform uncertainty in the parameter estimation of binary-black-hole signals*
